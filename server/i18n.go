...
var catalog = map[string]map[Lang]string{
	...
	// ── Accounts and roles ──
	"role.admin":    {LangEN: "Admin", LangDE: "Admin"},
	"role.operator": {LangEN: "Operator", LangDE: "Operator"},
	"usr.title":     {LangEN: "Accounts", LangDE: "Benutzer"},
	"usr.lead": {
		LangEN: "Who may sign in, and what they may do. An operator installs blades, reinstalls them, calls an installation off and takes one out of service. An admin does that and everything that decides what the fleet is.",
		LangDE: "Wer sich anmelden darf und was er darf. Ein Operator installiert Blades, installiert sie neu, bestellt eine Installation ab und nimmt eines außer Betrieb. Ein Admin darf das und alles, was bestimmt, was die Flotte ist."},
	"usr.accounts": {LangEN: "Accounts", LangDE: "Konten"},
	"usr.name":     {LangEN: "Name", LangDE: "Name"},
	"usr.role":     {LangEN: "Role", LangDE: "Rolle"},
	"usr.last":     {LangEN: "Last signed in", LangDE: "Zuletzt angemeldet"},
	"usr.never":    {LangEN: "never", LangDE: "nie"},
	"usr.password": {LangEN: "Password", LangDE: "Passwort"},
	"usr.newpw":    {LangEN: "new password", LangDE: "neues Passwort"},
	"usr.set":      {LangEN: "Set", LangDE: "Setzen"},
	"usr.you":      {LangEN: "you", LangDE: "du"},
	"usr.off":      {LangEN: "disabled", LangDE: "abgeschaltet"},
	"usr.enable":   {LangEN: "Enable", LangDE: "Einschalten"},
	"usr.disable":  {LangEN: "Disable", LangDE: "Abschalten"},
	"usr.delete":   {LangEN: "Remove", LangDE: "Entfernen"},
	"usr.add":      {LangEN: "New account", LangDE: "Neues Konto"},
	"usr.create":   {LangEN: "Create", LangDE: "Anlegen"},
	"usr.none":     {LangEN: "No account yet — the admin token is the only way in.", LangDE: "Noch kein Konto — der Admin-Token ist der einzige Weg hinein."},
	"usr.created":  {LangEN: "%s can sign in now", LangDE: "%s kann sich jetzt anmelden"},
	"usr.pwset":    {LangEN: "new password for %s", LangDE: "neues Passwort für %s"},
	"usr.roleset":  {LangEN: "%s is now %s", LangDE: "%s ist jetzt %s"},
	"usr.disabled": {LangEN: "%s can no longer sign in", LangDE: "%s kann sich nicht mehr anmelden"},
	"usr.enabled":  {LangEN: "%s can sign in again", LangDE: "%s kann sich wieder anmelden"},
	"usr.deleted":  {LangEN: "account %s removed", LangDE: "Konto %s entfernt"},
	"usr.delask":   {LangEN: "Remove the account %s?", LangDE: "Konto %s entfernen?"},
	"usr.astoken": {
		LangEN: "You are signed in with the admin token rather than an account. That is the way back in when nobody can sign in any more; for everyday work, give yourself an account.",
		LangDE: "Du bist mit dem Admin-Token angemeldet, nicht mit einem Konto. Das ist der Weg zurück, wenn sich niemand mehr anmelden kann; für die tägliche Arbeit lege dir ein Konto an."},
	"usr.hint": {
		LangEN: "Passwords are stored as PBKDF2-SHA256 with a salt of their own, never in clear. The last administrator who can still sign in cannot be removed, demoted or disabled — the admin token is a recovery route, not an account. Sessions last twelve hours; a role that changes reaches somebody at their next sign-in.",
		LangDE: "Passwörter liegen als PBKDF2-SHA256 mit eigenem Salz, nie im Klartext. Der letzte Administrator, der sich noch anmelden kann, lässt sich nicht entfernen, herabstufen oder abschalten — der Admin-Token ist ein Rückweg, kein Konto. Sitzungen halten zwölf Stunden; eine geänderte Rolle wirkt bei der nächsten Anmeldung."},
	"err.notallowed": {
		LangEN: "that is for an administrator",
		LangDE: "das darf nur ein Administrator"},
	"err.username": {
		LangEN: "a name of 2 to 32 letters, digits, dot, dash or underscore",
		LangDE: "ein Name aus 2 bis 32 Buchstaben, Ziffern, Punkt, Strich oder Unterstrich"},
	"err.userrole":   {LangEN: "unknown role", LangDE: "unbekannte Rolle"},
	"err.userpw":     {LangEN: "the password needs at least ten characters", LangDE: "das Passwort braucht mindestens zehn Zeichen"},
	"err.usertaken":  {LangEN: "there is already an account called %s", LangDE: "ein Konto namens %s gibt es schon"},
	"err.nosuchuser": {LangEN: "no account called %s", LangDE: "kein Konto namens %s"},
	"err.lastadmin": {
		LangEN: "this is the last administrator who can sign in — give somebody else the role first",
		LangDE: "das ist der letzte Administrator, der sich anmelden kann — gib die Rolle erst jemand anderem"},
	"login.user": {LangEN: "Name", LangDE: "Name"},
	"login.astoken": {
		LangEN: "or leave the name empty and enter the admin token",
		LangDE: "oder den Namen leer lassen und den Admin-Token eingeben"},
	"nav.users": {LangEN: "Accounts", LangDE: "Benutzer"},
